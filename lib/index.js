...
export const reducePlugins = (state, action) => {
  ...
  switch (type) {
    case USER_SELECT_WALLET:
      newState = safeSet(
        newState,
        `${PLUGIN_NAMESPACE}.selectedWallet`,
        walletId
      );
      return newState;
    case USER_SELECT_ACCOUNT:
      newState = safeSet(
        newState,
        `${PLUGIN_NAMESPACE}.selectedAccount`,
        accountId
      );
      return newState;
    case USER_SELECT_MULTISIG_WALLET:
      newState = safeSet(
        newState,
        `${PLUGIN_NAMESPACE}.selectedMultisigWallet`,
        walletId
      );
      return newState;
    case USER_SELECT_MULTISIG_PROPOSAL:
      newState = safeSet(
        newState,
        `${PLUGIN_NAMESPACE}.selectedProposal`,
        proposalId
      );
      return newState;
    case USER_SELECT_XPUB:
      newState = safeSet(
        newState,
        `${PLUGIN_NAMESPACE}.selectedXPUB`,
        selectedXPUB
      );
      return newState;
    case UPDATE_TEXT_FIELD:
      newState = safeSet(newState, `${PLUGIN_NAMESPACE}.textFields.${field}`, {
        value,
        valid
      });
      return newState;
