...
class MultisigWallet extends Component {
  constructor(props) {
    ...
    this.unselectedComponent = (<div className="col-sm"><Header type="h5">No wallet selected</Header></div>);
  }
    ...
    return (
      <div className="container">
        <ActionWrapper>
          ...
          <ConditionalRender
            shouldRender={shouldRender.MultisigUX}
          >
            <JoinWallet />
            <CreateProposal />
            <ProposalList />
            ...
            <ConditionalRender
              shouldRender={shouldRender.ProposalUX}
            >
              <ProposalUX />
            </ConditionalRender>
          </ConditionalRender>
