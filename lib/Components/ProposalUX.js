      ...
      <div>
       ...
       <div className="row">
         <Input
           ...
           onChange={e => handleUpdate(preventDefault(e).target.value, 'proposalUXCosignerAccountInput')}
         />
       </div>
       <div className="row">
...
const mapStateToProps = (state, otherProps) => {
  ...
  const { selectedMultisigWallet, selectedProposal, textFields = {} } = pluginState;
