      ...
      },
      {
        ...
        body: (
          <MultisigWallet
            ...
            proposalUXCosignerTokenInput={this.state.textFields.proposalUXCosignerTokenInput}
            proposalUXCosignerAccountInput={this.state.textFields.proposalUXCosignerAccountInput}
          />
        )
      }
    ];
