    ...
    try {
      switch (type) {
        ...
        case 'newProposal':
          ...
          // assert txoptions has certain keys

          // TODO: use token...

          // multisig wallet client create proposal
          const resp = await this.multisigWalletClient.createProposal(walletId, proposalName, txoptions);
