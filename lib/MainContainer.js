    ...
    try {
      switch (type) {
        ...
        case 'multisigApprove':
          console.log(value)
          console.assert(value.walletId !== undefined, 'must select a multisig wallet');
          console.assert(value.proposalId !== undefined, 'must select a proposal');
          console.assert(value.account !== undefined, 'Please select a hardware account');
          ...
          const approvalResponse = await this.multisigWalletClient.post(`/${value.walletId}/proposal/${value.proposalId}/approve`, { tx: raw, token: value.token });
    ...
    const tabs = [
      {
        ...
        body: (
          <SelectWallet
            ...
            textFields={{
              sendBalanceInput: textFields.sendBalanceInput,
              recipientInput: textFields.recipientInput,
              transactionFeeInput: textFields.transactionFeeInput,
              accountNameInput: textFields.accountNameInput,
              sendWalletPassphraseInput: textFields.sendWalletPassphraseInput,
            }}
          />
        )
      },
      {
        ...
        body: (
          <CreateWallet
            ...
            handleCreate={this.handleCreate}
            textFields={{
              walletNameInput: textFields.walletNameInput,
              createWalletPassphraseInput: textFields.createWalletPassphraseInput
            }}
          />
        )
      },
      {
        ...
        body: (
          <MultisigWallet
            ...
            handleCreate={this.handleCreate}
            textFields={{
              joinKeyInput: textFields.joinKeyInput,
              cosignerPathInput: textFields.cosignerPathInput,
              joinXpubInput: textFields.joinXpubInput,
              createWalletMInput: textFields.createWalletMInput,
              createWalletNInput: textFields.createWalletNInput,
              hardwareAccountInput: textFields.hardwareAccountInput,
              multisigWalletNameInput: textFields.multisigWalletNameInput,
              createCosignerNameInput: textFields.createCosignerNameInput,
              joinCosignerNameInput: textFields.joinCosignerNameInput,
              proposalNameInput: textFields.proposalNameInput,
              multisigSendBalanceInput: textFields.multisigSendBalanceInput,
              multisigTransactionFeeInput: textFields.multisigTransactionFeeInput,
              multisigRecipientInput: textFields.multisigRecipientInput,
              proposalCosignerTokenInput: textFields.proposalCosignerTokenInput,
              proposalUXCosignerTokenInput: textFields.proposalUXCosignerTokenInput,
              proposalUXCosignerAccountInput: textFields.proposalUXCosignerAccountInput,
            }}
          />
        )
      }
