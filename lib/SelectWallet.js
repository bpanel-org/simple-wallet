...
class SelectWallet extends Component {
  ...
  // not sure if this will call too many times...
      ...
      <div className="container">
        ...
        <div className="row" styles={styles.componentContainer}>
          ...
          <div className="col-sm">
            ...
            <QRCode containerStyle={styles.qrCodeContainer} style={styles.qrCodeContainer} text={receiveAddress} />
            <Button
              type="action"
              style={styles.wideButton}
...
const mapStateToProps = (state, otherProps) => {
  ...
  const receiveAddress = safeEval(() => state.wallets.accountInfo[selectedWallet][selectedAccount].receiveAddress, '');
  ...
  const walletBalance = safeEval(() => new Amount(info[selectedWallet].balance.confirmed).toBTC(), '');
  const accountBalance = safeEval(() => new Amount(balance[selectedWallet][selectedAccount].confirmed).toBTC(), '');
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    getMultisigWallets: async () =>
      dispatch(getMultisigWallets()),
  }
};
