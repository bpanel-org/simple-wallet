...
class SelectWallet extends Component {
  ...
  render() {
    ...
    const accountTableData = buildSingleColumnTable(selectedAccounts, 'Accounts');
        ...
        <div className="row" style={styles.componentContainer}>
          ...
          <div className="col-sm">
            ...
            <Input
              ...
              onChange={e =>
                handleFieldUpdate(preventDefault(e).target.value, 'accountNameInput')
              }
            />
            <Button
              type="action"
        ...
        <div className="row" styles={styles.componentContainer}>
          <div className="col-sm">
            ...
            <Input
              ...
              style={styles.inputStyle}
              onChange={e =>
                handleFieldUpdate(preventDefault(e).target.value, 'sendBalanceInput')
              }
            />
            <Input
              type="text"
              ...
              onChange={e =>
                handleFieldUpdate(preventDefault(e).target.value, 'recipientInput')
              }
            />
            <Input
              type="text"
