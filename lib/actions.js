...
const multisigClient = () => getClient().multisig;
...
export const hydrateWallets = () => async (dispatch, getState) => {
  await dispatch(getWallets());
  const selectedWallet = getState().plugins[PLUGIN_NAMESPACE].selectedWallet;
  dispatch(getAccounts(selectedWallet));
  await dispatch(getMultisigWallets());
};
