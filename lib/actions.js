...
export const getMultisigWalletProposalMTX = (walletId, proposalId) => async dispatch => {
  const mtx = await multisigClient.getProposalMTX(walletId, proposalId, { path: true, scripts: true });
